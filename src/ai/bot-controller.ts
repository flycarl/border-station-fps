...
const AIM_ERROR_YAW_BOUND = 0.125;
const AIM_ERROR_PITCH_BOUND = 0.088;
const REACTION_DELAY_MIN = 0.45;
const REACTION_DELAY_SPREAD = 0.35;
const FIRE_BURST_DURATION = 0.28;
const FIRE_BURST_CYCLE = 0.76;
